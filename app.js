...
const displayHardwareInfo = (prop) => {
 const result = typeof hardwareprops[prop](); 
// const result = typeof hardwareprops[prop]() === 'object' ?hardwareprops[prop]().map(cpu => ({ JSON.stringify(...cpu)).join(', ') })) : hardwareprops[prop](); 
